...
|                                        |                        | s:session-set         |                                     |         |
|----------------------------------------+------------------------+-----------------------+-------------------------------------+---------|
| logOut(s: Session, ss:System) |    |        |                                     |    session set reduces     |
|                                        |                        | s:session-set  |                                     |         |
|----------------------------------------+------------------------+-----------------------+-------------------------------------+---------|
| getEmail(u: User, s:Session)           |                        | u:user-set            |                                     |         |
|                                        |                        | s:session-set  |           returns email of the user                          |         |
|                                        |                        |                       |                                     |         |
|----------------------------------------+------------------------+-----------------------+-------------------------------------+---------|
| getName(u: User, s:Session)            |                        | u:user-set            |                                     |         |
|                                        |                        | s:session-set  |          returns name of the user                           |         |
|----------------------------------------+------------------------+-----------------------+-------------------------------------+---------|
| getRole(u: User, s:Session)            |                        | u:user-set            |                                     |         |
|                                        |                        | s:session-set         |  returns role of the user                          |         |
|----------------------------------------+------------------------+-----------------------+-------------------------------------+---------|
| editEmail(u:User, s:Session, e:Email)   | s.user.role = admin  | u:user-set            |                                     |         |
|                                        |               | s:session-set         |                                     |         |
|----------------------------------------+------------------------+-----------------------+-------------------------------------+---------|
| editName(u:User, s:Session, n:Name)     | s.user.role = admin  | u:user-set            |                                     |         |
|                                        |              | s:session-set         |                                     |         |
|----------------------------------------+------------------------+-----------------------+-------------------------------------+---------|
| editRole(u:User, s:Session, r:Role)     | s.user.role = admin  | u:user-set            |                                     |         |
|                                        |               | s:session-set         |                                     |         |
|----------------------------------------+------------------------+-----------------------+-------------------------------------+---------|
...
|----------------------------------------+------------------------+-----------------------+-------------------------------------+---------|
| showUsers(s:Session)                   |                        | s:session-set         |  success                                   |         |
|----------------------------------------+------------------------+-----------------------+-------------------------------------+---------|
|                                        |                        |                       |                                     |         |
