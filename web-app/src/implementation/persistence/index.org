...
** Session
A new class called Session has been defined. The ”init” takes dictionary in the form of kwargs and checks if the user whose session is being created is present. It creates a session if the user is present in the userlist and raises an error otherwise.
#+BEGIN_SRC python :tangle ../../src/db.py :eval no
class Session():
    user=None
...
** System
A new class called System has been defined to simplify writing different methods of relevance for the application by making the userlist and sessionlist attributes of this class.
*** Definition
#+BEGIN_SRC python :tangle ../../src/db.py :eval no
...
#+END_SRC
**** start_session
Once the user logs in a session is created for the user. Here email of the user whose session needs to be started is passed is the argument. The user set is filtered as to find the user with that email. This user's session is created by creating an instance of session class and passing the user
#+BEGIN_SRC python :tangle ../../src/db.py :eval no
...
#+END_SRC
**** stop_session
Once the user logs out a session is terminated for the user. Here email of the user whose session needs to be stopped is passed is the argument. The session set is filtered as to find the user with that email. This user's session is terminated by removing the user from the session set
#+BEGIN_SRC python :tangle ../../src/db.py :eval no
...
#+END_SRC
**** addUser
A method called add_user has been defined to take in the user to be added and the session of the user performing the action as arguments. The constructor of the method ensures that the actor is of role admin and raises an error otherwise. Also a filter checks if the user trying to be added already exists taking email as the unique identification.
...
**** getEmailOfUser
This method takes the user whose email is being requested as an argument and checks his presence in the user set and returns his email.
#+BEGIN_SRC python :tangle ../../src/db.py :eval no
...
**** getNameOfUser
This method takes the user whose name is being requested as an argument and checks his presence in the user set and returns his name.
#+BEGIN_SRC python :tangle ../../src/db.py :eval no
...
**** getUserByEmail
This method takes the email  whose user is being requested as an argument and checks his presence in the user set and returns corresponding user.
#+BEGIN_SRC python :tangle ../../src/db.py :eval no
...
**** del_user
This method has been defined to delete a specific user from the system. The method has been defined in a way such that it takes the user to be deleted and the session of the actor and checks if he is an admin and then deletes him from the userlist.
#+BEGIN_SRC python :tangle ../../src/db.py :eval no
...
**** get_sessions
This method just returns the sessionlist or a session of of the useras demanded.
#+BEGIN_SRC python :tangle ../../src/db.py :eval no
...
#+END_SRC
**** set_user
Adds the user to the session set
#+BEGIN_SRC python :tangle ../../src/db.py :eval no
